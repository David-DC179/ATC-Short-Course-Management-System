            ...
            <div class="row flex-nowrap ">
                    <div class="col-auto col-md-4 col-xl-2 px-sm-2 px-0 bg- text-dark" style=" background-color:#B9F88E;">
                        <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-dark min-vh-100">
                                ...
                                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                                         ...
                                         <li>
                                            <div class="btn btn-outline-primary px-4 mt-3" style=" border: 2px solid grey; padding: 10px;">
                                                <a href="../forms/add_receipt.php" class="nav-link align-middle px-0">
                                                <i class="fs-4 bi-person-plus text-dark fw-bold"></i> <br> <span class="ms-1 d-none d-sm-inline text-dark fw-bold">Add Receipt</span>
                                                </a>  
                                            </div> 
                                        </li>
                                        ...
                                        <li>
                                            <div class="btn btn-outline-success px-4 mt-3" style=" border: 2px solid grey; padding: 10px;">
                                                ...
                                                <i class="fs-4  bi-table text-dark fw-bold" width="16" height="16"></i> <br> <span class="ms-1 d-none d-sm-inline text-dark fw-bold">View Receipt</span>
                                                </a>  
                                            </div> 
                                        </li>
                                ...
                                <br> <span class="ms- d-none d-sm-inline text-dark fw-bold">Request Control Number</span> </a>
                                </li>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="float-md-start">
                                    <h3 class="h3"> LIST OF RECEIPT</h3>
                                </div>
